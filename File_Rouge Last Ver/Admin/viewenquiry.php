        ...
        <div class="col-sm-9">
            ...
            <form method="post">
                <table border="0" width="90%" height="300px" align="center" class="tableshadow">
                    <tr>
                        <td class="toptd">View Bookings</td>
                    </tr>
                    <tr>
                            ...
                            <table border="0" align="center" width="95%">
                                <thead>
                                    <tr>
                                        ...
                                        <td style="font-size:15px; padding:5px; font-weight:bold; ">Offer Id</td>
...
$s="select * from enquiry,offer where enquiry.Offerid=offer.Offerid";
