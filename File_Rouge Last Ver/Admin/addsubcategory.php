        ...
        <div class="col-sm-9">
            ...
            <form method="post" enctype="multipart/form-data">
                <table border="0" width="400px" height="300px" align="center" class="tableshadow">
                    <tr>
                        <td colspan="2" class="toptd">Add SubDirection</td>
                    </tr>
                    <tr>
                        <td class="lefttxt">SubDirection Name</td>
                        <td><input type="text" name="t1" required pattern="[a-zA-z _]{2,50}" title="Please Enter Only
                                Characters between 2 to 50 for Subcategory name" /></td>
                    </tr>
                    <tr>
