        ...
        <div class="col-sm-9">
            ...
            <form method="post">
                <table border="0" width="500px" height="300px" align="center" class="tableshadow">
                    <tr>
                        <td colspan="2" class="toptd">Update Direction</td>
                    </tr>
                    <tr>
                        <td class="lefttxt">Selected Direction Name</td>
...
?>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php if(isset($_POST["show"])){ echo $Cat_name ;} ?>" name="t2"
                                required pattern="[a-zA-z _]{3,10}" title="Please Enter Only Characters between 3 to 10
                                for Category Name" /></td>
                    </tr>
