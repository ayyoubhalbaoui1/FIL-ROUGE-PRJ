        ...
        <div class="col-sm-9">
            ...
            <form method="post" enctype="multipart/form-data">
                <table border="0" width="450px" height="500px" align="center" class="tableshadow">
                    <tr>
                        <td colspan="2" class="toptd">Update SubDirection</td>
                    </tr>
                    <tr>
...
?>
                    ...
                    <tr>
                        <td class="lefttxt">SubDirection Name</td>
                        <td><input type="text" value="<?php if(isset($_POST["show"])){ echo $Subcatname ;} ?> "
                                name="t1" required pattern="[a-zA-z1 _]{1,50}"
                                title="Please Enter Only Characters and numbers between 1 to 50 for Subcategory Name" />
                        </td>
                    </tr>
                    <tr>
